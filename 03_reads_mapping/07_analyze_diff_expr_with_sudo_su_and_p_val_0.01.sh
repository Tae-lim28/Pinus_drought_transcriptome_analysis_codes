...
# I'm going to extcut this code at "02_Pinus/14_mapped_file/edgeR_output/"
# I'm going to execute this code with "nohup sh shell_script.sh > 13_analyze_diff_expr_p_val_0.01_log.txt 2>&1 &"
